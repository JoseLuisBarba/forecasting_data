...
#         # Dejamos el pipeline numérico vacío para que no se aplique ninguna transformación
#         numerical_pipeline = Pipeline([])  
...
#         self.preprocessor = ColumnTransformer(
#             transformers=[
#                 ('num', 'passthrough', numerical_cols),  # No se aplica ningún cambio a las columnas numéricas
#                 ('cat', categorical_pipeline, categorical_cols)
#             ]
#         )
#         self.numerical_cols = numerical_cols
